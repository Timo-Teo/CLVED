...
public class GUI_Donador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        buttonGroupEnfermedades.add(rbtnEnfermedadRenalCronica);
        ...
        buttonGroupEnfermedades.add(rbtnNinguno);
        ...
        lblParentezco.setText("Parentesco");
    ...
    private void btnAgregarDonadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarDonadorActionPerformed
        ...
        try {
            //TOMAMOS Y COMPROBAMOS LOS CAMPOS NOMBRE, APELLIDO , EDAD
            ...
            if (nombre.equals("") || apellido.equals("")) {
                ...
                if (edad < 18 || edad > 101) {
                    ...
                    if (cmbTipoSangre.getSelectedItem().equals("Seleccionar")) {
                        ...
                        //TOMAMOS EL TIPO DE SANGRE DEL DONADOR
                        ...
                        //SE COMPRUEBA EL GRADO DE PATENTESCO
                        if (cmbGrado1.getSelectedItem().equals("1er Grado") && cmbGrado2.getSelectedItem().equals("2do Grado")
                                && cmbGrado3.getSelectedItem().equals("3er Grado")) {
                            ...
                            if (enfermedadDonador.equals("")) {
                                ...
                                //INSERCION DEL DONADOR A LA LISTA DE DONADORES
                                ...
                                //CALCULO DEL PORCENTAJE DE COMPATIBILIDAD
                                porcentajeCompatiblidad = donadorC.calcularPorcenteCompatibilidadTotal();

                                //INSERCION DEL DONADOR AL ARBOL
